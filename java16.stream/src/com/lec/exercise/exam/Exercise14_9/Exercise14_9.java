package com.lec.exercise.exam.Exercise14_9;
...
//                      Collectors.summingLong(Student::getScore))));
		...
		Map<Integer, Map<Integer, Long>> totalScoreByHakAndBan = Stream.of(stuArr)
				...
				/*
				 Map<Integer, Map<Integer, Long>> totalScoreByHakAndBan = Stream.of(stuArr).collect(
groupingBy(Student::getHak,groupingBy(Student::getBan,summingLong(Student::getScore)
